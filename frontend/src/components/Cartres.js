  ...
  return (
    <section className="ticket">
      ...
      <Card style={{ width: '10rem' }}>
        ...
        <Card.Body>
          <Card.Title><strong>Encanador em casa</strong></Card.Title>
          <Card.Text>
      ...
      <Card style={{ width: '10rem ' }}>
        ...
        <Card.Body>
          <Card.Title><strong>Pedreiro</strong></Card.Title>
          <Card.Text>
            Carlos Osorio oferece seu trabalho Pedreiro disponível para transferência mora em Recife, Pernambuco
            113256789
          </Card.Text>
        </Card.Body>
      </Card>
      ...
      <Card style={{ width: '10rem' }}>
        ...
        <Card.Body>
          <Card.Title> <strong>Cuidador , experiente, leito disponível</strong></Card.Title>
          <Card.Text>
      ...
      <Card style={{ width: '10rem ' }}>
        <Card.Img variant="top" src="https://img.freepik.com/foto-gratis/retrato-panadero-sexo-masculino-joven-confiado-delante-estantes-cocidos-cruasan_23-2148189030.jpg?w=740&t=st=1684959383~exp=1684959983~hmac=b2313ff97fdcb1fcd681165500e340872ed22d3efa7c9a7aefe284e5b27988e2" width={"300px,300px"} />
        <Card.Body>
          <Card.Title><strong>Auxiliar de Padaria</strong></Card.Title>
          <Card.Text>
            Carlos Prato tem cinco anos de experiência como auxiliar de padaria, Recife
            113256789
          </Card.Text>
        </Card.Body>
      </Card>
      ...
      <Card style={{ width: '10rem ' }}>
        <Card.Img variant="top" src="https://img.freepik.com/foto-gratis/nina-sostiene-productos-limpieza-guantes-trapos-cuenca-pared-blanca_1150-21780.jpg?w=740&t=st=1684959636~exp=1684960236~hmac=e1f4dfdda4f4c87fcc9a7113f1fbed0a52d99271a0ded916e60a2a1fc64eb00a" width={"300px,300px"} />
        <Card.Body>
